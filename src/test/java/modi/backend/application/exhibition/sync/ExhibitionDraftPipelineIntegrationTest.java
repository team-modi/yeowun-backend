...
class ExhibitionDraftPipelineIntegrationTest {
	...
	void 파이프라인_AI장애_대기() {
		...
		message.recordFailure(modi.backend.domain.exhibition.sync.outbox.OutboxFailureType.RETRYABLE,
				"전 공급자 실패", new modi.backend.domain.exhibition.sync.outbox.RetryPolicy(
